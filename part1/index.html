    ...
    <div class="main" id="tentang">
      ...
      <div class="main-content">
        <div class="container-content">
          <img class="banner" src="img/school3.jpg" alt="" />
        ...
        <ul class="list">
          <li class="item">
            <div class="d-flex flex-column">
                <div class="w-100" style="background-image: url(https://picsum.photos/200); height: 400px;"></div>
    ...
    <div class="main" id="berita">
      ...
      <div class="container-berita">
        <div class="berita-utama">
          <img class="gambar-berita" src="img/school3.jpg" alt="" />
        ...
        <div class="list-berita">
          <div class="content-berita">
            <img class="gambar-berita-list" src="./img/school3.jpg" alt="" />
